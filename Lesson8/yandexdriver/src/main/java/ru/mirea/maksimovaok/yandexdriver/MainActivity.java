...
import ru.mirea.maksimovaok.yandexdriver.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener, UserLocationObjectListener {
    ...
    private final Point ROUTE_START_LOCATION = new Point(56.038708, 37.743535);
    private final Point ROUTE_END_LOCATION = new Point(55.775852, 37.607970);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isWork) {
            ...
            final Point userLoc = new Point(56.038708, 37.743535);
            submitRequest(userLoc);

            PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new
                            Point(55.775852, 37.607970),
                    ImageProvider.fromResource(this, R.drawable._1));
