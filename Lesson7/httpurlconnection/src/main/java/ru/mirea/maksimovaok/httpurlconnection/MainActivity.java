package ru.mirea.maksimovaok.httpurlconnection;
...
import ru.mirea.maksimovaok.httpurlconnection.databinding.ActivityMainBinding;
                ...
                if(responseJson.has("current_weather")) {
                    ...
                    for (Map.Entry<String, Object> entry : weatherData.entrySet()) {
                        ...
                        if(entry.getKey().equals("temperature")) {
                            binding.Temperature.setText(value);
                        } else {
